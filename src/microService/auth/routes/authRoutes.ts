...
authRouter.put("/updateInvoice/:id", verifyAdmin,invoiceController.updateInvoice);
authRouter.delete("/updateActive/:id", verifyAdmin,invoiceController.updateActive);
